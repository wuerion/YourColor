...
const RULES = [
  ...
  // El verano clásico "cenizo"
  {
    ...
    match: (r) =>
      ...
      ["rubioCenizo", "cenizo", "cafeCenizo"].includes(r.tono_cabello) &&
  ...
  // Neutro, bajo contraste, tonos "polvorientos"
  {
    ...
    match: (r) =>
      ...
      ["cenizo", "castañoClaro", "rubioOscuro"].includes(r.tono_cabello) &&
      // Ojos suaves
  ...
  // Cabello oscuro pero cálido
  {
    ...
    match: (r) =>
      ...
      ["castañoOscuro", "negroSuave", "caoba"].includes(r.tono_cabello) &&
  ...
  // Tipo "Blancanieves": Piel clara, Pelo negro, Ojos claros
  {
    ...
    match: (r) =>
      ["clara", "morena"].includes(r.tono_piel) &&
      ["frio", "neutro"].includes(r.subTono_piel) &&
      ["negro", "negroAzulado", "castañoOscuro"].includes(r.tono_cabello) &&
      ["azulBrillante", "verdeOjos", "azulClaro"].includes(r.color_ojos),
    textResult:
...

  {
    ...
    match: (r) =>
      ...
      r.ropa !== "coloresFrios" &&
      r.accesorios !== "plateados" &&
      !["negro", "negroAzulado", "grisOBlanco"].includes(r.tono_cabello),
    cautionResult: springLight,
    result: spring,
  },
